 ...
 */
final class Version20220307131647 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE programme ADD abn INT DEFAULT NULL');
    }
