 ...
 */
final class Version20220305134358 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE suivi_programme ADD note INT DEFAULT NULL, CHANGE nombre_de_seances nombre_de_seances INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE suivi_programme DROP note, CHANGE remarque remarque VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE nombre_de_seances nombre_de_seances INT DEFAULT NULL');
