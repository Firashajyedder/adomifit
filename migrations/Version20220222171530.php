 ...
 */
final class Version20220222171530 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE calendar ADD suivi_regime_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE calendar ADD CONSTRAINT FK_6EA9A1465C472E5A FOREIGN KEY (suivi_regime_id) REFERENCES suivi_regime (id)');
        $this->addSql('CREATE INDEX IDX_6EA9A1465C472E5A ON calendar (suivi_regime_id)');
    }
